...
36 Hour deadline group project with the goal of creating an optimization model that can determine optimal reservoir placement in a grid to minimize water transportation costs.
